...
const Sidebar2 = () => {
	...
	return (
		<div className="d-flex flex-column flex-shrink-0 bg-black h-100" style={{ width: '4.5rem' }}>
			<a
				href="/"
			...
			<div className="h-100 d-flex">
				<ul className="nav nav-pills nav-flush m-auto flex-column text-center h-50 justify-content-around main-sidebarx">
